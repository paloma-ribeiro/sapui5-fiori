sap.ui.define([
	"sap/ui/test/Opa5",
	"numen/talentos/ztlnt202104/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("numen.talentos.ztlnt202104.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "numen.talentos.ztlnt202104",
					async: true
				},
				hash: oOptions.hash,
