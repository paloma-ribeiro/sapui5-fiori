		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CompanhiasAéreas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CompanhiasAéreas-display": {
								"semanticObject": "CompanhiasAéreas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=numen.talentos.ztlnt202104",
									"url": sap.ui.require.toUrl("numen/talentos/ztlnt202104")
								}
							}
						}
					}
