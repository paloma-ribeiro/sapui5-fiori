sap.ui.define([
	...
	return BaseController.extend("numen.talentos.ztlnt202104.controller.Master", {
        ...
        onBtnCreatePress: function (oEvent) {
            if (!this.oDialogEditCompany) {
                this.oDialogEditCompany = Fragment.load({
                    ...
                    name: "numen.talentos.ztlnt202104.view.Popup",
                    controller: this
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					id: this.getView().getId(),
					name: "numen.talentos.ztlnt202104.view.ViewSettingsDialog",
					controller: this
				}).then(function(oDialog){
